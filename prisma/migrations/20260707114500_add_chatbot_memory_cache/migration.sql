...
ALTER TABLE
  "chat_sessions"
ADD
  COLUMN IF NOT EXISTS "userId" UUID;
...
-- AddForeignKey
ALTER TABLE
  "chat_sessions" DROP CONSTRAINT IF EXISTS "chat_sessions_userId_fkey";
...
-- AddForeignKey
ALTER TABLE
  "user_preferences" DROP CONSTRAINT IF EXISTS "user_preferences_userId_fkey";
...
-- AddForeignKey
ALTER TABLE
  "chat_memory_vectors" DROP CONSTRAINT IF EXISTS "chat_memory_vectors_userId_fkey";

ALTER TABLE
  "chat_memory_vectors"
ADD
  CONSTRAINT "chat_memory_vectors_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;