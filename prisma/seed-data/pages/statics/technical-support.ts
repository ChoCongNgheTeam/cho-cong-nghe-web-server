...
export const technicalSupportPage: PageSeedData = {
  title: "Quy định hỗ trợ kỹ thuật và sao lưu dữ liệu",
  slug: "quy-dinh-ho-tro-ky-thuat",
  type: PageType.PAGE, // Chuyển thành PAGE
  policyType: null,    // Xóa policyType
  isPublished: true,
  priority: 10, // Đặt số ưu tiên tiếp theo trong mảng trang tĩnh
...
//   metaDescription: "Các quy định quan trọng về việc sao lưu dữ liệu, bảo mật tài khoản cá nhân và hỗ trợ cài đặt phần mềm khi khách hàng mang thiết bị đến bảo hành, sửa chữa.",
  content: `
    <div class="min-h-screen text-primary leading-relaxed mb-10 w-full">
        <h1 class="font-bold mb-5 text-primary text-center text-2xl">
        ...
        <ul class="space-y-3">
            <li class="flex gap-3 leading-relaxed text-primary">
                <span class="w-6 h-6 rounded-full flex items-center justify-center shrink-0 font-bold bg-promotion-light text-promotion mt-0.5 text-xs">1</span>
            ...
            <li class="flex gap-3 leading-relaxed text-primary">
                <span class="w-6 h-6 rounded-full flex items-center justify-center shrink-0 font-bold bg-promotion-light text-promotion mt-0.5 text-xs">2</span>
                <span>ChoCongNghe không chịu trách nhiệm về việc mất dữ liệu của Quý khách trong quá trình cài đặt, bảo hành sửa chữa.</span>
            </li>
            <li class="flex gap-3 leading-relaxed text-primary">
                <span class="w-6 h-6 rounded-full flex items-center justify-center shrink-0 font-bold bg-promotion-light text-promotion mt-0.5 text-xs">3</span>
            ...
            <li class="flex gap-3 leading-relaxed text-primary">
                <span class="w-6 h-6 rounded-full flex items-center justify-center shrink-0 font-bold bg-promotion-light text-promotion mt-0.5 text-xs">4</span>
                <span>ChoCongNghe không hỗ trợ cài đặt phần mềm không có bản quyền trên máy tính của Quý khách.</span>
            </li>
            <li class="flex gap-3 leading-relaxed text-primary">
                <span class="w-6 h-6 rounded-full flex items-center justify-center shrink-0 font-bold bg-promotion-light text-promotion mt-0.5 text-xs">5</span>
            ...
            <li class="flex gap-3 leading-relaxed text-primary">
                <span class="w-6 h-6 rounded-full flex items-center justify-center shrink-0 font-bold bg-promotion-light text-promotion mt-0.5 text-xs">6</span>
                <span>Tài khoản cài đặt trên máy phải là tài khoản cá nhân của Quý khách (chủ sở hữu máy).</span>
            </li>
            <li class="flex gap-3 leading-relaxed text-primary">
                <span class="w-6 h-6 rounded-full flex items-center justify-center shrink-0 font-bold bg-promotion-light text-promotion mt-0.5 text-xs">7</span>
