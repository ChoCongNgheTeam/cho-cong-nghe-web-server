...
export const variantImages: Record<string, Record<string, string[]>> = {
  "iPhone 13": {
    black: Array.from({ length: 5 }, (_, i) => `products/iphone-13/black/image-0${i + 1}.webp`),
    white: Array.from({ length: 5 }, (_, i) => `products/iphone-13/white/image-0${i + 1}.webp`),
    red: Array.from({ length: 5 }, (_, i) => `products/iphone-13/red/image-0${i + 1}.webp`),
    pink: Array.from({ length: 5 }, (_, i) => `products/iphone-13/pink/image-0${i + 1}.webp`),
    blue: Array.from({ length: 5 }, (_, i) => `products/iphone-13/blue/image-0${i + 1}.webp`),
    "alpine-green": Array.from(
      { length: 5 },
      (_, i) => `products/iphone-13/alpine-green/image-0${i + 1}.webp`,
    ),
  },

  "iPhone 14": {
    black: Array.from({ length: 5 }, (_, i) => `products/iphone-14/black/image-0${i + 1}.webp`),
  },

  "iPhone 15": {
    black: Array.from({ length: 5 }, (_, i) => `products/iphone-15/black/image-0${i + 1}.webp`),
  },

  "iPhone 16": {
    black: Array.from({ length: 5 }, (_, i) => `products/iphone-16/black/image-0${i + 1}.webp`),
  },

  "iPhone 16 Plus": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/iphone-16-plus/black/image-0${i + 1}.webp`,
    ),
  },
  ...
  "iPhone 16 Pro Max": {
    "titan-black": Array.from(
      { length: 5 },
      (_, i) => `products/iphone-16-pro-max/titan-black/image-0${i + 1}.webp`,
    ),
  },

  "iPhone 17": {
    black: Array.from({ length: 5 }, (_, i) => `products/iphone-17/black/image-0${i + 1}.webp`),
  },

  "iPhone 17 Pro": {
    silver: Array.from(
      { length: 5 },
      (_, i) => `products/iphone-17-pro/silver/image-0${i + 1}.webp`,
    ),
  },
  ...
  "iPhone 17 Pro Max": {
    orange: Array.from(
      { length: 5 },
      (_, i) => `products/iphone-17-pro-max/orange/image-0${i + 1}.webp`,
    ),
  },
  ...
  "Macbook Air 13 M4 2025 10CPU/8GPU/16GB/256GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/macbook-air-13-m4-2025-10cpu-8gpu-16gb-256gb/black/image-0${i + 1}.webp`,
    ),
  },
  ...
  "Macbook Air 13 M2 2024 8CPU/8GPU/16GB/256GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/macbook-air-13-m2-2024-8cpu-8gpu-16gb-256gb/black/image-0${i + 1}.webp`,
    ),
  },
  ...
  "Macbook Air 13 M4 2025 10CPU/10GPU/16GB/512GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/macbook-air-13-m4-2025-10cpu-10gpu-16gb-512gb/black/image-0${i + 1}.webp`,
    ),
  },
  ...
  "Macbook Air 13 M4 2025 10CPU/10GPU/24GB/512GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/macbook-air-13-m4-2025-10cpu-10gpu-24gb-512gb/black/image-0${i + 1}.webp`,
    ),
  },
  ...
  "Macbook Air 15 M4 2025 10CPU/10GPU/16GB/512GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/macbook-air-15-m4-2025-10cpu-10gpu-16gb-512gb/black/image-0${i + 1}.webp`,
    ),
  },
  ...
  "Macbook Air 15 M4 2025 10CPU/10GPU/16GB/256GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/macbook-air-15-m4-2025-10cpu-10gpu-16gb-256gb/black/image-0${i + 1}.webp`,
    ),
  },
  ...
  "MacBook Air 15 inch M2 2023 8CPU 10GPU/8GB/512GB/Sạc 70W": {
    black: Array.from(
      { length: 5 },
      (_, i) =>
        `products/macbook-air-15-inch-m2-2023-8cpu-10gpu-8gb-512gb-sac-70w/black/image-0${i + 1}.webp`,
    ),
  },
  ...
  "MacBook Pro 14 M4 Pro 2024 12CPU/16GPU/24GB/512GB": {
    black: Array.from(
      { length: 5 },
      (_, i) =>
        `products/macbook-pro-14-m4-pro-2024-12cpu-16gpu-24gb-512gb/black/image-0${i + 1}.webp`,
    ),
  },
  ...
  "MacBook Pro 14 M4 Pro 2024 14CPU/20GPU/24GB/1TB": {
    black: Array.from(
      { length: 5 },
      (_, i) =>
        `products/macbook-pro-14-m4-pro-2024-14cpu-20gpu-24gb-1tb/black/image-0${i + 1}.webp`,
    ),
  },
  ...
  "MacBook Pro 14 2023 M3 Pro 12 CPU/18 GPU/18GB/1TB": {
    black: Array.from(
      { length: 5 },
      (_, i) =>
        `products/macbook-pro-14-2023-m3-pro-12-cpu-18-gpu-18gb-1tb/black/image-0${i + 1}.webp`,
    ),
  },
  ...
  "MacBook Pro 14 M4 Max 2024 14CPU/32GPU/36GB/1TB": {
    black: Array.from(
      { length: 5 },
      (_, i) =>
        `products/macbook-pro-14-m4-max-2024-14cpu-32gpu-36gb-1tb/black/image-0${i + 1}.webp`,
    ),
  },
  ...
  "Macbook Pro 14 M5 2025 10CPU/10GPU/16GB/512GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/macbook-pro-14-m5-2025-10cpu-10gpu-16gb-512gb/black/image-0${i + 1}.webp`,
    ),
  },
  ...
  "Macbook Pro 14 M5 2025 10CPU/10GPU/24GB/512GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/macbook-pro-14-m5-2025-10cpu-10gpu-24gb-512gb/black/image-0${i + 1}.webp`,
    ),
  },
  ...
  "MacBook Pro 16 M4 Pro 2024 14CPU/20GPU/24GB/512GB": {
    black: Array.from(
      { length: 5 },
      (_, i) =>
        `products/macbook-pro-16-m4-pro-2024-14cpu-20gpu-24gb-512gb/black/image-0${i + 1}.webp`,
    ),
  },
  ...
  "MacBook Pro 16 M4 Pro 2024 14CPU/20GPU/48GB/512GB": {
    black: Array.from(
      { length: 5 },
      (_, i) =>
        `products/macbook-pro-16-m4-pro-2024-14cpu-20gpu-48gb-512gb/black/image-0${i + 1}.webp`,
    ),
  },
  ...
  "MacBook Pro 16 M4 Max 2024 14CPU/32GPU/36GB/1TB": {
    black: Array.from(
      { length: 5 },
      (_, i) =>
        `products/macbook-pro-16-m4-max-2024-14cpu-32gpu-36gb-1tb/black/image-0${i + 1}.webp`,
    ),
  },
  ...
  "MacBook Pro 16 M4 Max 2024 16CPU/40GPU/48GB/1TB": {
    black: Array.from(
      { length: 5 },
      (_, i) =>
        `products/macbook-pro-16-m4-max-2024-16cpu-40gpu-48gb-1tb/black/image-0${i + 1}.webp`,
    ),
  },
  ...
  "Samsung Galaxy Z Fold7 5G 12GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/samsung-galaxy-z-fold7-5g-12gb/black/image-0${i + 1}.webp`,
    ),
  },
  "Samsung Galaxy Z Flip7 5G 12GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/samsung-galaxy-z-flip7-5g-12gb/black/image-0${i + 1}.webp`,
    ),
  },
  "Samsung Galaxy A56 5G 8GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/samsung-galaxy-a56-5g-8gb/black/image-0${i + 1}.webp`,
    ),
  },
  "Samsung Galaxy A36 5G 8GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/samsung-galaxy-a36-5g-8gb/black/image-0${i + 1}.webp`,
    ),
  },
  "Samsung Galaxy S25 Ultra 5G 12GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/samsung-galaxy-s25-ultra-5g-12gb/black/image-0${i + 1}.webp`,
    ),
  },
  "Samsung Galaxy S25 5G 12GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/samsung-galaxy-s25-5g-12gb/black/image-0${i + 1}.webp`,
    ),
  },
  "Samsung Galaxy S25 Plus 5G 12GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/samsung-galaxy-s25-plus-5g-12gb/black/image-0${i + 1}.webp`,
    ),
  },
  "Samsung Galaxy S25 FE 5G 8GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/samsung-galaxy-s25-fe-5g-8gb/black/image-0${i + 1}.webp`,
    ),
  },
  "Samsung Galaxy A26 5G 8GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/samsung-galaxy-a26-5g-8gb/black/image-0${i + 1}.webp`,
    ),
  },
  "Samsung Galaxy Z Fold6 5G": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/samsung-galaxy-z-fold6-5g/black/image-0${i + 1}.webp`,
    ),
  },
  "Samsung Galaxy S24 FE 5G": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/samsung-galaxy-s24-fe-5g/black/image-0${i + 1}.webp`,
    ),
  },
  "Samsung Galaxy S25 Edge 5G": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/samsung-galaxy-s25-edge-5g/black/image-0${i + 1}.webp`,
    ),
  },
  "Samsung Galaxy S24 Ultra 5G": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/samsung-galaxy-s24-ultra-5g/black/image-0${i + 1}.webp`,
    ),
  },
  "Xiaomi Poco F8 Pro 5G 12GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/xiaomi-poco-f8-pro-5g-12gb/black/image-0${i + 1}.webp`,
    ),
  },
  "Xiaomi Poco X7 5G 12GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/xiaomi-poco-x7-5g-12gb/black/image-0${i + 1}.webp`,
    ),
  },
  "Xiaomi Poco M7 Pro 5G 8GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/xiaomi-poco-m7-pro-5g-8gb/black/image-0${i + 1}.webp`,
    ),
  },
  "Xiaomi Poco M6 Pro 8GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/xiaomi-poco-m6-pro-8gb/black/image-0${i + 1}.webp`,
    ),
  },
  "Xiaomi Poco C71 4GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/xiaomi-poco-c71-4gb/black/image-0${i + 1}.webp`,
    ),
  },
  "Xiaomi Redmi Note 15 Pro 5G 12GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/xiaomi-redmi-note-15-pro-5g-12gb/black/image-0${i + 1}.webp`,
    ),
  },
  "Xiaomi Redmi Note 15 5G 6GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/xiaomi-redmi-note-15-5g-6gb/black/image-0${i + 1}.webp`,
    ),
  },
  "Xiaomi Redmi Note 15 6GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/xiaomi-redmi-note-15-6gb/black/image-0${i + 1}.webp`,
    ),
  },
  "Xiaomi Redmi Note 14 Pro Plus 5G 8GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/xiaomi-redmi-note-14-pro-plus-5g-8gb/black/image-0${i + 1}.webp`,
    ),
  },
  "Xiaomi Redmi Note 14 5G 8GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/xiaomi-redmi-note-14-5g-8gb/black/image-0${i + 1}.webp`,
    ),
  },
  "Xiaomi Redmi Note 14 6GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/xiaomi-redmi-note-14-6gb/black/image-0${i + 1}.webp`,
    ),
  },
  "Xiaomi Redmi 15 5G 8GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/xiaomi-redmi-15-5g-8gb/black/image-0${i + 1}.webp`,
    ),
  },
  "Xiaomi Redmi 14C 4GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/xiaomi-redmi-14c-4gb/black/image-0${i + 1}.webp`,
    ),
  },
  "Xiaomi Redmi 13x 8GB": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/xiaomi-redmi-13x-8gb/black/image-0${i + 1}.webp`,
    ),
  },
  "Comfee Inverter 1.5 HP CFS-13VGP": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/comfee-inverter-1-5-hp-cfs-13vgp/black/image-0${i + 1}.webp`,
    ),
  },
  "Casper Inverter 1.5 HP GC-12IB36": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/casper-inverter-1-5-hp-gc-12ib36/black/image-0${i + 1}.webp`,
    ),
  },
  "Casper Inverter 1 HP TC-09IS35": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/casper-inverter-1-hp-tc-09is35/black/image-0${i + 1}.webp`,
    ),
  },
  "Casper Inverter 1.5 HP GC-12IS35": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/casper-inverter-1-5-hp-gc-12is35/black/image-0${i + 1}.webp`,
    ),
  },
  "Tai nghe có dây Apple EarPods USB-C 2023 (MYQY3ZA/A)": {
    black: Array.from(
      { length: 5 },
      (_, i) =>
        `products/tai-nghe-co-day-apple-earpods-usb-c-2023-myqy3za-a/black/image-0${i + 1}.webp`,
    ),
  },
  "Tai nghe có dây Apple EarPods Lightning (MWTY3ZA/A)": {
    black: Array.from(
      { length: 5 },
      (_, i) =>
        `products/tai-nghe-co-day-apple-earpods-lightning-mwty3za-a/black/image-0${i + 1}.webp`,
    ),
  },
  "Tai nghe có dây Apple EarPods Lightning (MMTN2ZA/A)": {
    black: Array.from(
      { length: 5 },
      (_, i) =>
        `products/tai-nghe-co-day-apple-earpods-lightning-mmtn2za-a/black/image-0${i + 1}.webp`,
    ),
  },
  "Tai nghe Apple AirPods Pro 3 2025 USB-C": {
    black: Array.from(
      { length: 5 },
      (_, i) => `products/tai-nghe-apple-airpods-pro-3-2025-usb-c/black/image-0${i + 1}.webp`,
    ),
  },
};
