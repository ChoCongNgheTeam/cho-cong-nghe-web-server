...
export const galaxyS25FE: SeedProductInput = {
  name: "Samsung Galaxy S25 FE 5G 8GB",
  description: `
    ...
    <p class="text-neutral-darker">
      <strong class="font-semibold text-primary">Galaxy S25 FE</strong> (Fan Edition) mang đến những tính năng AI cốt lõi và hiệu năng mạnh mẽ trong một mức giá dễ tiếp cận. Màn hình Dynamic AMOLED 2X 120Hz cùng hệ thống camera chuyên nghiệp giúp bạn bắt trọn mọi khoảnh khắc rực rỡ.
    </p>
