...
export const galaxyS25Plus: SeedProductInput = {
  ...
  description: `
    ...
    <p class="text-neutral-darker">
      Với màn hình QHD+ rực rỡ và dung lượng pin lớn, <strong class="font-semibold text-primary">Galaxy S25 Plus</strong> là lựa chọn giải trí đỉnh cao. Công nghệ Galaxy AI hỗ trợ phiên dịch trực tiếp cuộc gọi và tìm kiếm thông minh giúp cuộc sống của bạn trở nên đơn giản và hiện đại hơn.
    </p>
