...
export const galaxyS25Edge: SeedProductInput = {
  ...
  description: `
    ...
    <p class="text-neutral-darker">
      <strong class="font-semibold text-primary">Galaxy S25 Edge</strong> đánh dấu sự trở lại của thiết kế màn hình cong quyến rũ, tối ưu không gian hiển thị. Hệ thống tản nhiệt buồng hơi lớn giúp máy duy trì hiệu suất ổn định khi chơi game nặng hoặc xử lý video 4K.
    </p>
