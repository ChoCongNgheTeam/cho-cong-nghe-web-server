...
export const galaxyS24FE: SeedProductInput = {
  ...
  description: `
    ...
    <p class="text-neutral-darker">
      <strong class="font-semibold text-primary">Galaxy S24 FE</strong> kế thừa trọn vẹn bộ công cụ Galaxy AI từ dòng S24 cao cấp. Khả năng kháng nước IP68 và khung viền nhôm chắc chắn đảm bảo máy luôn bền bỉ, sẵn sàng cùng bạn khám phá mọi hành trình.
    </p>
