...
export const galaxyA07_5G: SeedProductInput = {
  name: "Samsung Galaxy A07 5G 4GB",
  description: `
    <h2 class="mt-2 text-base sm:text-xl font-semibold text-primary">Galaxy A07 5G – 5G cho mọi nhà</h2>
    <p class="text-neutral-darker">
      <strong class="font-semibold text-primary">Galaxy A07 5G</strong> là bước tiến mới giúp người dùng dễ dàng tiếp cận công nghệ 5G với mức giá cực kỳ tiết kiệm. Pin dung lượng lớn đảm bảo liên lạc thông suốt cả ngày dài.
    </p>
