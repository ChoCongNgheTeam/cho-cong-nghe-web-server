...
export const galaxyA16_5G: SeedProductInput = {
  name: "Samsung Galaxy A16 5G 8GB",
  description: `
    ...
    <p class="text-neutral-darker">
      Tận hưởng tốc độ mạng 5G đỉnh cao cùng <strong class="font-semibold text-primary">Galaxy A16 5G</strong>. Với 8GB RAM, máy xử lý mượt mà các tựa game phổ biến và hỗ trợ công việc nhanh chóng, hiệu quả.
    </p>
