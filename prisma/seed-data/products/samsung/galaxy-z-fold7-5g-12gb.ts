...
export const galaxyZFold7: SeedProductInput = {
  name: "Samsung Galaxy Z Fold7 5G 12GB",
  description: `
    ...
    <p class="text-neutral-darker">
      <strong class="font-semibold text-primary">Galaxy Z Fold7</strong> mở ra kỷ nguyên mới với thiết kế mỏng nhẹ kỷ lục và màn hình gập không nếp nhăn. Tích hợp Galaxy AI thông minh hỗ trợ dịch thuật trực tiếp và ghi chú chuyên nghiệp, biến chiếc điện thoại thành một trạm làm việc di động thực thụ.
    </p>
