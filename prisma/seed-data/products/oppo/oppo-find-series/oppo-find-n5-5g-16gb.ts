...
export const oppoFindN5: SeedProductInput = {
  ...
  description: `
    ...
    <p class="text-neutral-darker">
      <strong class="font-semibold text-primary">OPPO Find N5</strong> mang đến thiết kế gập không nếp nhăn kỷ lục và độ mỏng ấn tượng. Với RAM 16GB, máy xử lý đa nhiệm cực đại, cho phép mở đồng thời nhiều cửa sổ ứng dụng mà vẫn mượt mà, tối ưu cho hiệu suất công việc.
    </p>
