...
export const oppoFindX9Pro: SeedProductInput = {
  ...
  description: `
    ...
    <p class="text-neutral-darker">
      <strong class="font-semibold text-primary">OPPO Find X9 Pro</strong> sở hữu sức mạnh vô song với RAM 16GB và hệ thống camera cảm biến 1-inch phối hợp cùng Hasselblad. Màn hình LTPO 120Hz rực rỡ và khả năng xử lý hình ảnh AI đỉnh cao biến mọi khung hình trở thành tác phẩm nghệ thuật.
    </p>
