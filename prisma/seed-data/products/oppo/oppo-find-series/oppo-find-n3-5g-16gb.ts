...
export const oppoFindN3: SeedProductInput = {
  name: "OPPO Find N3 5G 16GB",
  description: `
    <h2 class="mt-2 text-base sm:text-xl font-semibold text-primary">OPPO Find N3 – Bậc thầy đa nhiệm trên tay bạn</h2>
    <p class="text-neutral-darker">
      <strong class="font-semibold text-primary">OPPO Find N3</strong> vẫn là một trong những chiếc smartphone gập được yêu thích nhất với tỉ lệ màn hình hoàn hảo và hệ thống camera chuyên nghiệp không thua kém các dòng máy thanh.
    </p>
