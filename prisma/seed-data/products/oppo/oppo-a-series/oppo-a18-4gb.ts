...
export const oppoA18: SeedProductInput = {
  ...
  description: `
    ...
    <p class="text-neutral-darker">
      Dù là dòng máy khởi điểm, <strong class="font-semibold text-primary">OPPO A18</strong> vẫn được ưu ái trang bị màn hình 90Hz cho trải nghiệm vuốt chạm cực mượt. Thiết kế lấp lánh và khả năng mở rộng RAM ảo giúp máy vượt qua giới hạn của một thiết bị giá rẻ.
    </p>
