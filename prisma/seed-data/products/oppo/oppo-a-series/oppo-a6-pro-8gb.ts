...
export const oppoA6Pro: SeedProductInput = {
  ...
  description: `
    ...
    <p class="text-neutral-darker">
      <strong class="font-semibold text-primary">OPPO A6 Pro</strong> mang đến sự kết hợp hoàn hảo giữa dung lượng RAM 8GB và thiết kế hiện đại. Máy tập trung vào sự bền bỉ với viên pin lớn và khả năng tối ưu hóa hệ điều hành giúp sử dụng mượt mà trong thời gian dài.
    </p>
