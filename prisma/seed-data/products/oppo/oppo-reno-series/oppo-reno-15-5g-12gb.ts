...
export const oppoReno15_5G: SeedProductInput = {
  ...
  description: `
    ...
    <p class="text-neutral-darker">
      <strong class="font-semibold text-primary">OPPO Reno15 5G</strong> định nghĩa lại khả năng nhiếp ảnh di động với hệ thống camera AI đột phá. Thiết kế mặt lưng dòng chảy thời thượng kết hợp cùng màn hình cong 120Hz mang lại trải nghiệm cầm nắm cực kỳ sang trọng và mượt mà.
    </p>
