...
export const oppoReno15F_5G: SeedProductInput = {
  ...
  description: `
    ...
    <p class="text-neutral-darker">
      <strong class="font-semibold text-primary">Reno15 F 5G</strong> là sự lựa chọn hoàn hảo cho giới trẻ yêu thích thời trang và công nghệ. Máy mỏng nhẹ kỷ lục nhưng vẫn mang trong mình sức mạnh 5G và hệ thống camera bắt trọn mọi khoảnh khắc lung linh.
    </p>
