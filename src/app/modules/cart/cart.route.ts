...
import { addToCartSchema, updateCartItemSchema, cartItemParamsSchema, validateItemSchema, syncCartSchema, validateLocalCartSchema } from "./cart.validation";
...
router.post(
  "/get",
  authMiddleware(false), // <--- Chỉ áp dụng riêng cho route này
  getCartLimiter,
