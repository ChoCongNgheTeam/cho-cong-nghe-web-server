...
import { shipmentQuerySchema, createShipmentSchema, bulkCreateShipmentSchema, bulkPrintLabelSchema, upsertShippingProviderSchema } from "./shipping.validation";
...
router.post("/admin/shipments/bulk-print", validate(bulkPrintLabelSchema, "body"), asyncHandler(c.printBulkLabelsHandler));
